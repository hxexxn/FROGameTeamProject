		...
		<div class="content">
			...
			<div class="content_box">
				...
				<div class="read_header_content">
					<div class="read_header_content_box" style="white-space: pre-wrap;">${dto.notice_content}</div>
