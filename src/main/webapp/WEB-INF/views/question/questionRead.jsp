...
<body>
	...
	<div id="contentFrame">
			...
			<div class="content_box">
				...
				<div class="read_header_count_regdate">
					<div class="read_header_count_regdate_box1">
						<div class="read_header_count_regdate_box2">view :
							${dto.question_count}</div>
						<div class="read_header_count_regdate_box2">
							date :
							<fmt:formatDate value="${dto.question_regdate}"
								pattern="yyyy-MM-dd" />
						</div>
						<div class="read_header_count_regdate_box2">writer :
							${dto.question_writer}</div>
					</div>
				</div>

				<div class="read_header_content">
					<div class="read_header_content_box"
						style="white-space: pre-wrap; wrap: hard;">${dto.question_content}</div>
		...
		<div class="reply_head">
			...
			<c:if test="${sessionScope.user_nick == dto.question_writer}">
				<span class="Btn"><a
					href="/questionUpdate?question_no=${dto.question_no}"
					class="noticeListBtn">수정</a> </span>
				<span class="Btn"><a
					href="/questionDelete?question_no=${dto.question_no}"
					class="noticeListBtn">삭제</a> </span>
			</c:if>
	...
	<script type="text/javascript"
		src="${path}/resources/js/questionRead.js"></script>
